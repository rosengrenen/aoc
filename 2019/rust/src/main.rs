...
fn main() {
	...
	if part.is_none() || part.unwrap() == 1 {
		...
		match part1_answer {
			SolverResult::Num(num) => println!("Day {} (part 1) answer: {}", day, num),
			// SolverResult::Text(text) => println!("Day {} (part 1) answer:\n{}", day, text),
		}
	...
	if part.is_none() || part.unwrap() == 2 {
		...
		match part2_answer {
			SolverResult::Num(num) => println!("Day {} (part 2) answer: {}", day, num),
			// SolverResult::Text(text) => println!("Day {} (part 2) answer:\n{}", day, text),
		}
